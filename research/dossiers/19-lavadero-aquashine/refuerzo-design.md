# Refuerzo de Diseño & Sistema Visual: Lavadero Aquashine

## 🎨 Paleta de Colores Sugerida (OKLCH / CSS Tokens)
- **Modo / Atmósfera**: Azul Eléctrico (#0284C7), Gris Titanio (#334155), Neón Cyan (oklch(0.78 0.18 190))
...
- **Familia Elegida**: Space Grotesk (Títulos) + Inter (Cuerpo)
- **Escala H1 Contenida (Anti-Gigantismo)**: `clamp(2.2rem, 3.8vw, 3.2rem)`

---

## 🗺️ Sitemap Sugerido (Estructura de Secciones)
- 1. Hero Brillo & Proteccion Extrema
- 2. Servicios de Lavado & Detail
- 3. Galería Antes/Después
- 4. Preguntas Frecuentes
- 5. Pedir Turno por WhatsApp
